...
defaults write NSGlobalDomain AppleHighlightColor -string "0.749000 0.847100 0.980400"

# Set sidebar icon size to small (1 = small, 2 = medium)
...
# Trackpad: haptic feedback (0: Light, 1: Medium, 2: Firm)
...
# Trackpad: disable swipe up with three fingers (Mission Control)
...
# Set a blazingly fast keyboard repeat rate (options: 0, 1, 2 - lower is faster)
...
# Set the icon size of Dock maximum magnification level
...
# open "prefs/Solarized Dark.itermcolors"
...
# Set up the recommended keyboard shortcuts
...
# To adjust the width of the todo application
